      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="library" className="mb-8">
          ...
          <TabsContent value="library">
            ...
            {/* Books Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 animate-slide-up mb-8">
              {paginatedBooks.map((book, index) => (
                ...
                >
                  <Card className="glassmorphism-card border-0 shadow-md overflow-hidden hover-lift flex flex-col h-full cursor-pointer">
