  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Books Grid */}
        <div className="bento-grid gap-8 animate-slide-up mb-8">
          {paginatedBooks.map((book, index) => (
            ...
            >
              <Card
                className="glassmorphism-card border-0 shadow-md overflow-hidden hover-lift flex flex-col h-full cursor-pointer"
            >
